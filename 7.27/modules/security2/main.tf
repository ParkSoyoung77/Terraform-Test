...
# # ==================================================================
# resource "aws_security_group" "std17_alb_sg2" {
#     name        = "std17-alb-sg2"
#     vpc_id      = var.vpc2_id
...
#     tags = { Name = "std17-alb-sg2" }
# }

# # ==================================================================
# # test-sg: 80은 ALB SG에서만, SSH/3306은 self만 유지
# # ==================================================================
# resource "aws_security_group" "std17_test_sg2" {
#     name        = "std17-test-sg2"
#     vpc_id      = var.vpc2_id
...
#         to_port         = 80
#         protocol        = "tcp"
#         security_groups = [aws_security_group.std17_alb_sg2.id]
