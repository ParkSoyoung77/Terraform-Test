...
# ==================================================================
# ECR 엔드포인트 전용 보안그룹 (443 허용)
# ==================================================================
resource "aws_security_group" "std17_ecr_endpoint_sg" {
  name        = "std17-ecr-endpoint-sg"
  vpc_id      = var.vpc_id
  description = "ECR Interface Endpoint - HTTPS 443 from VPC"

  ingress {
    from_port   = 443
    to_port     = 443
    protocol    = "tcp"
    cidr_blocks = [var.vpc_cidr]  # 예: "10.0.0.0/16"
  ...
  tags = { Name = "std17-ecr-endpoint-sg" }
}